...
select
  ...
  try_cast(trunc(id) as number(18,0))       as id,
  try_cast(name as varchar)          as name,
  try_cast(trunc(data_intr_time) as number(18,0)) as data_intr_time,
  ...
  try_cast(trunc(uv) as number(18,0))       as uv,
  try_cast(trunc(uvi) as number(18,0))      as uvi,
  try_cast(illumi as number)         as illumi,
  try_cast(rain as number)           as rain,
  try_cast(rain_1_h as number)        as rain_1h,
  try_cast(rain_24_h as number)       as rain_24h,
  try_cast(rain_bgn as number)       as rain_bgn,
  try_cast(trunc(wind_dir) as number(18,0)) as wind_dir,
  ...
  try_cast(trunc(wbgt) as number(18,0))     as wbgt,
  try_cast(wbgt_str as varchar)      as wbgt_str,
  try_cast(trunc(atmos) as number(18,0))    as atmos,
