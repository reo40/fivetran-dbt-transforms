...
with src as (
  select
    ...
    {{ optional_col(source('raw','TMP_HINMOKU'), 'YOURYOU',               'CAST(NULL AS NUMBER(38,3))') }},
    ...
    {{ optional_col(source('raw','TMP_HINMOKU'), 'TSUKA',                 'CAST(NULL AS VARCHAR)') }},
    ...
    {{ optional_col(source('raw','TMP_HINMOKU'), 'HYOUJUN_GENKA',         'CAST(NULL AS NUMBER(38,3))') }},
    {{ optional_col(source('raw','TMP_HINMOKU'), 'HYOUJUN_GENKA_PER_KG',  'CAST(NULL AS NUMBER(38,3))') }},
